      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-md border border-border min-h-10 h-auto items-center justify-between bg-background hover:bg-muted transition-colors duration-200",
              className
            )}
          >
            ...
            <CommandList>
              ...
              <CommandGroup>
                <CommandItem
                  key="all"
                  onSelect={toggleAll}
                  className="cursor-pointer hover:bg-muted/50 rounded-sm px-2"
                >
                  <div
                    className={cn(
